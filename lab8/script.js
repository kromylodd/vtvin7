function profal() {
  ...
  function dark_light() {
    ...
    if (img.src.includes("lab7zad1.1.jpg")) {
      img.src = "https://wptest.local/wordpress-6.7.1-ru_RU/wordpress/wp-content/uploads/2024/12/lab7zad1.2.jpg";
      dm.innerHTML = "<i class='fa-solid fa-sun'></i>";
    } else {
      img.src = "https://wptest.local/wordpress-6.7.1-ru_RU/wordpress/wp-content/uploads/2024/12/lab7zad1.1.jpg";
